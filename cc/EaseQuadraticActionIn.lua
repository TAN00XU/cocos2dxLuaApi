...
--- 调用 `cc.EaseQuadraticActionIn:clone`。
---
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@return self 当前对象，便于链式调用。
...
--- 更新 `cc.EaseQuadraticActionIn:update` 对应的状态。
---
--- 参数说明：
--- - `time`：时间值。类型为 `number`。
---
...
--- 调用 `cc.EaseQuadraticActionIn:reverse`。
---
--- 返回说明：
...
--- 调用 `cc.EaseQuadraticActionIn:new`。
---
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@return self 当前对象，便于链式调用。
function EaseQuadraticActionIn:new() end
