...
--- 初始化 `cc.ParticleFireworks:init` 对应的对象或状态。
---
--- 返回说明：
--- - `boolean`：初始化是否成功。
...
--- 初始化 `cc.ParticleFireworks:initWithTotalParticles` 对应的对象或状态。
---
--- 参数说明：
...
--- 创建 `cc.ParticleFireworks:create` 对应的对象。
---
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
...
--- 创建 `cc.ParticleFireworks:createWithTotalParticles` 对应的对象。
---
--- 参数说明：
--- - `numberOfParticles`：参数 `numberOfParticles`，类型为 `integer`。
---
