...
--- 初始化 `cc.ParticleRain:init` 对应的对象或状态。
---
...
--- 初始化 `cc.ParticleRain:initWithTotalParticles` 对应的对象或状态。
---
--- 该声明来自 Cocos Lua 绑定提示桩，函数体为空，仅用于类型检查、补全和文档提示。
---
--- 参数说明：
...
--- 创建 `cc.ParticleRain:create` 对应的对象。
---
--- 该声明来自 Cocos Lua 绑定提示桩，函数体为空，仅用于类型检查、补全和文档提示。
---
--- 返回说明：
...
--- 创建 `cc.ParticleRain:createWithTotalParticles` 对应的对象。
---
--- 该声明来自 Cocos Lua 绑定提示桩，函数体为空，仅用于类型检查、补全和文档提示。
---
--- 参数说明：
