...
--- 初始化 `cc.ParticleSmoke:init` 对应的对象或状态。
---
--- 返回说明：
--- - `boolean`：初始化是否成功。
...
--- 初始化 `cc.ParticleSmoke:initWithTotalParticles` 对应的对象或状态。
---
--- 参数说明：
...
--- 创建 `cc.ParticleSmoke:create` 对应的对象。
---
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
...
--- 创建 `cc.ParticleSmoke:createWithTotalParticles` 对应的对象。
---
--- 参数说明：
--- - `numberOfParticles`：参数 `numberOfParticles`，类型为 `integer`。
---
