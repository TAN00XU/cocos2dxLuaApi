...
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@param d nil 参数 `d`，类型为 `nil`。
---@param t integer 参数 `t`，类型为 `integer`。
...
--- - `d`：参数 `d`，类型为 `cc.backend.TextureBacken`。
---
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@param slot integer 参数 `slot`，类型为 `integer`。
---@param d cc.backend.TextureBacken 参数 `d`，类型为 `cc.backend.TextureBacken`。
---@return self 当前对象，便于链式调用。
...
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@param modelView mat4_table 参数 `modelView`，类型为 `mat4_table`。
---@return self 当前对象，便于链式调用。
...
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@param binding cc.VertexAttribBinding 参数 `binding`，类型为 `cc.VertexAttribBinding`。
---@return self 当前对象，便于链式调用。
...
--- 返回说明：
--- - `self`：当前对象，便于链式调用。
---@param parent cc.Technique 父节点对象。类型为 `cc.Technique`。
