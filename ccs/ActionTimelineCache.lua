...
---
--- 返回说明：
--- - `ccs.ActionTimeline`：创建出的 `ccs.ActionTimeline` 对象或值。
---@param fileName string 文件名或文件路径。类型为 `string`。
---@return ccs.ActionTimeline 创建出的 `ccs.ActionTimeline` 对象或值。
...
---
--- 返回说明：
--- - `ccs.ActionTimeline`：`ccs.ActionTimeline` 对象或值。
---@param fileName string 文件名或文件路径。类型为 `string`。
---@return ccs.ActionTimeline `ccs.ActionTimeline` 对象或值。
